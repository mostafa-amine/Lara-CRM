...
<x-buttons.anchor :href="route('organizations.edit', $organization)" content="Edit organization" size="small"
    color="warning" />
@endcan
@can('delete', $organization)
<x-buttons.form :action="route('organizations.destroy', $organization)" content="Delete organization" size="small"
    color="danger" />
@endcan
<div class="card">
